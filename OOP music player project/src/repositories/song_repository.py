...
class SongRepository(BaseRepository):
    ...
    def read_by_id(self, song_id: str) -> Optional[Song]:
        ...
        Returns:
            Optional[Song]: Song instance if found, None otherwise
    ...
    def read_all(self) -> List[Song]:
        """Read (retrieve) all Songs from the database.
        
        Returns:
            List[Song]: List of Song instances (empty if none exist)
    ...
    def read_by_artist(self, artist: str) -> List[Song]:
        ...
        Returns:
            List[Song]: List of songs by the artist
    ...
    def read_by_genre(self, genre: str) -> List[Song]:
        ...
        Returns:
            List[Song]: List of songs in the genre
